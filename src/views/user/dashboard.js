export
  ...
  <section class="rounded-[2rem] bg-blue-600 px-8 py-10 text-white shadow-xl shadow-blue-100">
    ...
    <h1 id="dashboard-greeting" class="mt-3 text-4xl font-black tracking-tight">Bienvenida.</h1>
  ...
  <section class="mt-8 grid gap-4 md:grid-cols-3">
    <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
      ...
      <p id="stats-active" class="mt-3 text-4xl font-black text-blue-700">0</p>
    </article>
    <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
      <p class="text-sm text-slate-500">Completadas</p>
      <p id="stats-completed" class="mt-3 text-4xl font-black text-blue-700">0</p>
    </article>
    <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
      <p class="text-sm text-slate-500">Pendientes hoy</p>
      <p id="stats-pending" class="mt-3 text-4xl font-black text-blue-700">0</p>
    </article>
  </section>
  ...
  <section class="mt-8">
    <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
      ...
      <div class="mt-6 grid gap-4 sm:grid-cols-2">
        <a class="rounded-3xl bg-blue-50 p-5 hover:bg-blue-100" href="/task/new">
