  ...
  <section class="rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-50">
    ...
    <form id="task-form" class="mt-8 grid gap-5">
      ...
      <div class="flex flex-col gap-3 pt-2 sm:flex-row">
        ...
        <a href="/tasks"
          class="inline-flex items-center justify-center rounded-2xl border border-blue-200 bg-white px-5 py-3 text-sm font-bold text-blue-700 hover:bg-blue-50">Cancelar</a>
      </div>
    </form>
  </section>
</main> 
